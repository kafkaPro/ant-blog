...
type BaseMenu struct {
	...
	ParentId   uint                                           `p:"parentId"  orm:"parent_id"    json:"parentId"`  // 父菜单ID
...
type RoleMenuNode struct {
	RoleId uint `orm:"role_id" json:"roleId"`
	MenuId uint `orm:"menu_id" json:"menuId"`
	BaseMenu
	Children []*RoleMenuNode `json:"children"`
}
